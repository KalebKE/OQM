/*
OQMNetworkRenderer -- an interface within the Machine Artificial Vision
 ...
 * @author Kaleb
 */
public class OQMNetworkRenderer extends javax.swing.JPanel implements JUNGPanelAdapterInterface
{

    private JUNGPanelAdapter networkView;
    private double[][] system = new double[0][0];


    /** Creates new form SimulynDefaultNetworkRenderer */
    public OQMNetworkRenderer()
    {
        initComponents();
        networkView = new JUNGPanelAdapter(system);
